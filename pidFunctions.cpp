...
void pidFunctions(std::string in_file_name, std::string out_file_name = "PidFunctions.root"){
    ...
    particlesPid.push_back(new Pid("pionPos_400", "pol 4", "pol 4", "pol 3", h2_pq_mass2_tof400, { 35, 60 }, 5, {
            {-0.05, 0.05}, {-0.05, 0.05}, {-0.1, 0.1}, {-0.15, 0.1}, {-0.25, 0.1} }));
    particlesPid.push_back(new Pid("pionPos_700", "pol 4", "pol 5", "pol 4", h2_pq_mass2_tof700, { 35, 70 }, 5, {
            {-0.02, 0.05}, {-0.02, 0.05}, {-0.05, 0.1}, {-0.05, 0.1}, {-0.1, 0.1}, {-0.2, 0.15}, {-0.2, 0.15} }));

    particlesPid.push_back(new Pid("proton_400", "pol 4", "pol 3", "pol 3", h2_pq_mass2_tof400, { 35, 70 }, 5, {
            {0.8, 1.1}, {0.8, 1.1}, {0.7, 1.1}, {0.7, 1.1}, {0.6, 1.0}, {0.6, 1.0}, {0.4, 0.9} }));
    particlesPid.push_back(new Pid("proton_700", "pol 4", "pol 4", "pol 3", h2_pq_mass2_tof700, { 35, 75 }, 5, {
            {0.8, 1.1}, {0.8, 1.0}, {0.8, 1.0}, {0.8, 1.0}, {0.8, 1.0}, {0.7, 1.1}, {0.7, 1.1}, {0.7, 1.1} }));

    particlesPid.push_back(new Pid("deuteron_400", "pol 4", "pol 3", "pol 4", h2_pq_mass2_tof400, { 40, 70 }, 5, {
            {3.5, 4.}, {3.5, 4.}, {3.25, 4.}, {3., 4.}, {3., 4.}, {3., 4.} }));
    particlesPid.push_back(new Pid("deuteron_700", "pol 3", "pol 3", "pol 4", h2_pq_mass2_tof700, { 40, 70 }, 5, {3.25, 4.}));
    ...
    particlesPid.push_back(new Pid("triton_400", "pol 3", "pol 3", "pol 3", h2_pq_mass2_tof400, { 50, 70 }, 5, {
